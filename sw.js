...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-bfe228adc03896c4508b.js"
  },
  {
    "url": "app-b5a5eaf1d83431181baa.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "0bf721029a77da4e4fe83025a9054895"
  },
  {
    "url": "0.19b7858ce4d74eee0969.css"
  },
  {
    "url": "0-32d4db51036abe313eb3.js"
  },
  {
    "url": "component---src-pages-404-js-1c1d999184f90166048c.js"
  },
  {
...
var navigationRoute = new workbox.routing.NavigationRoute(function (_ref) {
  ...
  return idbKeyval.get(WHITELIST_KEY).then(function (customWhitelist) {
    ...
    if (customWhitelist.includes(pathname)) {
      var offlineShell = "/gatsby-gh-pages-tutorial/offline-plugin-app-shell-fallback/index.html";
...
var messageApi = {
  whitelistPathnames: function whitelistPathnames(event) {
    ...
    pathnames = pathnames.map(function (_ref3) {
      ...
      if (!includesPrefix) {
        return "/gatsby-gh-pages-tutorial" + pathname;
      } else {
        return pathname;
      }
    });
